...
(deftemplate orderstatus	;// tiente traccia delle ordinazioni
	...
	(slot arrivaltime)	;// momento in cui ï¿½ arrivata l'ordinazione
...
;//  pulitura (clean) del tavolol),  l'agente prende 3 penalitï¿½
...
;// per ogni istante di tempo che intercorre fra la request e la inform, l'agente prende 50 penalitï¿½
...
;// penalitï¿½ perchï¿½ l'ordine ï¿½ stato accepted e non ï¿½ ancora stato completato
...
;// penalitï¿½ perchï¿½ l'ordine ï¿½ stato delayed e non ï¿½ ancora stato completato 
...
;// La cella di partenza ï¿½ un seat in cui si trovava l'operatore
(defrule MovePerson3
   (declare (salience 10))    
        (status (step ?i) (time ?t))   
...
;// La cella in cui deve  andare la persona ï¿½ libera. Persona si muove. 
;// La cella di partenza ï¿½ occupata da cliente (Person) , per cui dopo lo spostamento 
...
;// La cella in cui deve andare il cliente ï¿½ un seat e il seat non ï¿½ occupata da altra persona.
...
;// La cella in cui deve andare il cliente ï¿½ un seat ma il seat ï¿½ occupata da altra persona.
...
;// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
;//
;// l'agente ha inviato inform che l'ordine ï¿½ accettato (e va bene)
...
;// l'agente ha inviato inform che l'ordine ï¿½ accettato (e ma non sono vere le condizioni)
...
;// l'agente ha inviato inform che l'ordine ï¿½ delayed (e va bene)
...
;// l'agente ha inviato inform che l'ordine ï¿½ delayed (e non va bene dovrebbe essere accepted)
...
;// l'agente ha inviato inform che l'ordine ï¿½ rejected (e non va bene dovrebbe essere accepted)
...
;// l'agente ha inviato inform che l'ordine ï¿½ rejected (e non va bene dovrebbe essere delayed)
...
;// l'agente invia un'inform  per un servizio che non ï¿½ piï¿½ pending
...
; operazione non serve, il tavolo ha giï¿½ richiesto cleantable 
...
;// operazione non serve, il tavolo ï¿½ gia pulito
...
;// Operazione sbagliata perchï¿½ chiede finish prima che l'ordine sia stato completato
...
;// L'azione di CheckFinish  fallisce perchï¿½ l'agente non ï¿½ accanto ad un tavolo 
...
;// L'azione di CheckFinish fallisce perchï¿½ la posizione indicata non 
;//contiene un tavolo 
...
;// c'ï¿½  richiesta di cleanTable o dopo CheckFinish positiva
...
;// azione inutile di cleantable perchï¿½ il tavolo ï¿½ giï¿½ pulito
...
;// il robot tenta di fare CleanTable  ma fallisce perchï¿½ sta giï¿½ trasportando cibo 
;// e o bevande
...
;// L'azione di CleanTable fallisce perchï¿½ l'agente non ï¿½ accanto ad un tavolo 
...
;// L'azione di CleanTable fallisce perchï¿½ la posizione indicata non 
;//contiene un tavolo 
...
;// Operazione inutile perchï¿½ agente non ha avanzi di cibo a bordo
...
;// Operazione fallisce perchï¿½ l'agente non ï¿½ adiacente a un TrashBasket
...
;// Operazione fallisce perchï¿½ la cella indicata non ï¿½ un TrashBasket
...
;// Operazione inutile perchï¿½ agente non ha contenitori di bevande a bordo
(defrule Release_KO1
	(declare (salience 20))       
?f2<-	(status (time ?t) (step ?i)) 
	(exec (step ?i) (action Release) (param1 ?x) (param2 ?y))
...
;// Operazione fallisce perchï¿½ l'agente non ï¿½ adiacente a un RecyclableBasket
(defrule Release_KO2
	(declare (salience 20))
?f2<-	(status (time ?t) (step ?i)) 
	(exec (step ?i) (action Release) (param1 ?x) (param2 ?y))
...
;// Operazione fallisce perchï¿½ la cella indicata non ï¿½ un RecyclableBasket
(defrule Release_KO3
	(declare (salience 20))
?f2<-	(status (time ?t) (step ?i)) 
	(exec (step ?i) (action Release) (param1 ?x) (param2 ?y))
...
;// Operazione fallisce perchï¿½ l'agente ï¿½ giï¿½ a pieno carico
...
;// Operazione fallisce perchï¿½ l'agente ï¿½ giï¿½ carico di immondizia
...
;// Operazione fallisce perchï¿½ l'agente non ï¿½ adiacente a un FoodDispenser
...
;// Operazione fallisce perchï¿½ la cella indicata non ï¿½ un FoodDispenser
...
;// Operazione fallisce perchï¿½ l'agente non ï¿½ adiacente a un drinkDispenser
...
;// Operazione fallisce perchï¿½ la cella indicata non ï¿½ un drinkDispenser
...
;// ï¿½ï¿½consegna Food su un tavolo che ha ordine ancora aperto
;// le penalitï¿½ di riferiscono alla durata dell'azione (4 unitï¿½ di tempo) 
...
;// assegna una penalitï¿½ nel caso in cui si tenti di consegnare un cibo ad un tavolo
;// quando l'ordinazione ï¿½ giï¿½ stata completata (ordestatus eleinato) o non ï¿½ mai stato fatto
...
;// ï¿½ï¿½consegna drink a un tavolo che ha ordine ancora aperto
;// le penalitï¿½ di riferiscono alla durata dell'azione (4 unitï¿½ di tempo) 
;// per i punti (2) per i cibi e bevande non ancora consegnati 
...
;// assegna una penalitï¿½ nel caso in cui si tenti di consegnare un cibo ad un tavolo
;// quando l'ordinazione ï¿½ giï¿½ stata completata o non ï¿½ stato fatto ordine
...
;// L'azione di delivery-food o delivery-drink fallisce perchï¿½ l'agente non ï¿½ accanto ad un tavolo 
...
;// L'azione di delivery-food o o delivery-drink fallisce perchï¿½ la posizione indicata non 
;//contiene un tavolo 
...
;	(printout t " ENVIRONMENT:" crlf)
;	(printout t " - penalitï¿½ +10000000 (Forward-north-bump): " (+ ?p 10000000) crlf)
)
...
=> 
	...
	(assert (penalty (+ ?p 10000000)))
;	(printout t " ENVIRONMENT:" crlf)
;	(printout t " - penalitï¿½ +10000000 (forward-south-bump): " (+ ?p 10000000) crlf)
) 
...
=> 
	...
	(assert (penalty (+ ?p 10000000)))
;	(printout t " ENVIRONMENT:" crlf)
;	(printout t " - penalitï¿½ +10000000 (forward-west-bump): " (+ ?p 10000000) crlf)
)
...
=> 
	...
	(assert (penalty (+ ?p 10000000)))
;	(printout t " ENVIRONMENT:" crlf)
;	(printout t " - penalitï¿½ +10000000 (forward-east-bump): " (+ ?p 10000000) crlf)
)
